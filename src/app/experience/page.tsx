      ...
      <div className="absolute px-7 lg:px-52">
          ...
          <div className="flex flex-col w-auto space-y-4 mt-12 text-white">
            ...
            <Link href="/projects" passHref>
              <div className="flex relative items-center w-auto group">
                <span>Projects</span>
                <svg
                  className="absolute top-0 left-[58px] w-3 h-3 group-hover:translate-x-2 transition-transform"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="rgba(255,255,255,1)"
                >
        ...
        <div className="">
          ...
          <div className="">
            <p
              id="bio"
              className={`${poppins.className} text-white mt-2 lg:text-xl`}
            >
              I specialize in HTML-CSS, JavaScript, React, and Next.js, with
              experience in modern, responsive frontend development. Currently
              pursuing a Master’s in Computer Applications, I’ve interned with
              tech startups and am now working on professional frontend
              projects, reflecting my passion for the field.
            </p>
          </div>
          {/* Tech stack */}
        ...
        <div>
          ...
          >
            <h2 className="text-white font-semibold">Ignitiv Technologies</h2>
            <p className="text-white text-xs">Apr 2024 - Jul 2024 </p>
            <p className="text-xs text-[#FF4B4E]">Internship </p>

            <h2 className="text-white font-semibold mt-5">
              Software Developer
            </h2>
            <p className="text-white text-sm">
              React | Express.js | REST API | Postman
            </p>
          </div>
          ...
          >
            <h2 className="text-white font-semibold">Rerqy</h2>
            <p className="text-white text-xs">Feb 2022 - March 2023 </p>
            <p className="text-xs text-[#FF4B4E]">Internship </p>

            <h2 className="text-white font-semibold mt-5">Project Intern</h2>
            <p className="text-white text-sm">
              Worked on the development of the SaaS business model.
            </p>
          </div>
          ...
          <div
            ...
            className="px-3 py-8 rounded bg-[#d9d9d932] lg:w-[400px]"
          >
            <h2 className="text-white font-semibold">Rarque</h2>
            <p className="text-white text-xs">Dec 2021 - Dec 2022 </p>
            <p className="text-xs text-[#FF4B4E]">Internship </p>
