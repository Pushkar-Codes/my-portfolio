...
const Projects = () => {
  useEffect(() => {
    ...
    const animateCards = (cards) => {
      gsap
        .timeline({
          scrollTrigger: {
            trigger: cards[0], // Trigger animation based on the first card
            start: "top 80%", // Start animation when the top of the first card hits 80% of the viewport
            scrub: true, // Smooth scrubbing, makes the animation tied to scroll
          },
        })
        .fromTo(
          cards, // Assuming cards is an array of elements
          { opacity: 0, scale: 0.8, y: 100 }, // Initial state for all cards
          {
            opacity: 1,
            scale: 1,
            y: 0,
            duration: 2.5,
            ease: "power5.out",
            stagger: 0.2, // Optional: stagger the animations for each card
          }
        );
    };

    // Animation for bioText
    gsap.timeline().fromTo(
      bioText,
      { opacity: 0, scale: 0.8, x: -100 }, // Initial state
      { opacity: 1, scale: 1, x: 0, duration: 3.5, ease: "power5.out" } // Final state
    );

    // Animate teachStack on scroll
    gsap.timeline().fromTo(
      teachStack,
      { opacity: 0, scale: 0.8, y: 100 }, // Initial state for teachStack
      {
        opacity: 1,
        scale: 1,
        y: 0,
        duration: 2.5,
        ease: "power5.out",
        stagger: 0.3, // Delay between each SVG animation
      }
    );
  ...
  return (
    <div>
      {/* Section 1 */}
      <div className="absolute px-7 lg:px-52">
        {/* Navbar */}
        <div className="py-16">
          <div className="flex flex-col w-auto space-y-4 mt-12 text-white">
            <Link href="/" passHref>
              <div className="flex relative items-center w-auto group">
                <span>Home</span>
                <svg
                  className="absolute top-0 left-10 w-3 h-3 group-hover:translate-x-2 transition-transform"
            ...
            <Link href="/experience" passHref>
              <div className="flex relative items-center w-auto group">
                ...
                <svg
                  className="absolute top-0 left-[105px] w-3 h-3 group-hover:translate-x-2 transition-transform"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="rgba(255,255,255,1)"
                >
        ...
        <div className="">
          <div className="left-10">
            <div className="flex">
              <h1
                className={`${krona.className} text-[#FF4B4E] text-2xl lg:text-6xl`}
              >
                My Projects
              </h1>
          ...
          <div className="flex space-x-8">
            <div className="border-r w-[60px] mt-8 flex">
              <svg
                id="stack"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <div className="w-[60px] mt-8 flex">
              <svg
                id="stack"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
        ...
        <div>
          <div
            id="card"
            className="mt-[80px] px-3 py-8 rounded bg-[#d9d9d932] lg:w-[400px]"
          >
            <div className="flex justify-end mb-8">
              <Link
                href="https://github.com/Pushkar-Codes/Travel-list-react.git"
                target="_blank"
            ...
            <h2 className="text-white font-semibold">
              Travel Organizer -- React.js{" "}
            </h2>

            <p className="text-white text-sm mt-5">
              An application using React hooks. A travel list manager where you
              can add, edit, or delete packing list items.
            </p>
          </div>

          <div className="flex items-center">
            <div className="h-24 ml-8 border-l-2 border-gray-500"></div>
          </div>

          <div
            id="card"
            className="px-3 py-8 rounded bg-[#d9d9d932] lg:w-[400px]"
          >
            <div className="flex justify-end mb-8">
              <Link
                href="https://github.com/Pushkar-Codes/Password-Generator.git"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <p className="text-[#FF4B4E] text-sm">Live</p>

            <h2 className="text-white font-semibold">
              Password Generator App -- React.js
            </h2>

            <p className="text-white text-sm mt-5">
              Its a password generator application with React and Tailwind that
              uses multiple filters to generate desired password.
            </p>
          </div>
          ...
          >
            <div className="flex justify-end mb-8">
              <Link
                href="https://codexartisans.netlify.app"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <h2 className="text-white font-semibold">
              Animated Website -- Javascript, GSAP, ScrollTrigger & Locomotive
            </h2>

            <p className="text-white text-sm mt-5">
              Used Javascript libraries to create a modern website with
              animations and responsive design for mobile devices.
            </p>
          </div>
          ...
          >
            <div className="flex justify-end mb-8">
              <Link
                href="https://github.com/Pushkar-Codes/Hit-Box-Game.git"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <h2 className="text-white font-semibold">
              Hit Box Bubble -- React.js
            </h2>

            <p className="text-white text-sm mt-5">
              A number puzzle game where user needs to click on the correct
              number to increase the score
            </p>
          </div>
          ...
          >
            ...
            <h2 className="text-white font-semibold">
              Website for Startup -- Next.js
            </h2>

            <p className="text-white text-sm mt-5">
              With Next.js and other libraries framer-motion, GSAP etc, I
              created a website for a new startup.
            </p>
          </div>
          ...
          >
            <div className="flex justify-end mb-8">
              <Link
                href="https://github.com/Pushkar-Codes/Weather-app-minimal-.git"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <h2 className="text-white font-semibold">
              Minimal Weather App -- HTML-CSS, Javascript & API
            </h2>

            <p className="text-white text-sm mt-5">
              Used OpenWeather API to create a minimal-looking weather app.
            </p>
          </div>
          ...
          <div className="flex items-center">
            <div
              id="card"
              className="h-24 ml-8 border-l-2 border-gray-500"
            ></div>
          </div>

          <div className="px-3 py-8 rounded bg-[#d9d9d932] lg:w-[400px]">
            <div className="flex justify-end mb-8">
              <Link
                href="https://www.therandomblogs.in"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <h2 className="text-white font-semibold">
              Tech Blog -- Google Blogger, SEO, Content Creation
            </h2>

            <p className="text-white text-sm mt-5">
              Created a tech blog with more than 5,00,000 visitors and Google’s
              first-page ranking, where I post blogs related to tech &
              automobiles.
            </p>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="mt-12 absolute lg:mt-24">
          ...
          <div className="left-10 top-10">
            <h3 className={`${krona.className} text-[#FF4B4E] text-xl`}>
              Hire me
            </h3>
            ...
            <div className="flex space-x-4 mt-1">
              <Link
                href="#"
                onClick={() =>
                  (window.location.href = "mailto:pushkardutt555@gmail.com")
                }
              >
                <svg
                  id="stack"
                ...
                >
                  <path fill="none" d="M0 0h24v24H0z"></path>
                  <path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2 3 3 3ZM20 7.23792L12.0718 14.338L4 7.21594V19H20V7.23792ZM4.51146 5L12.0619 11.662L19.501 5H4.51146Z"></path>
                </svg>
              </Link>

              <Link
                href="https://www.linkedin.com/in/pushkar-dutta"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
              ...
              <Link
                href="https://github.com/Pushkar-Codes"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
        ...
        <div className="flex mt-[165px] lg:mt-[210px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="rgba(74,85,103,1)"
            width="22"
            height="22"
          >
            <path fill="none" d="M0 0h24v24H0z"></path>
          ...
          <p id="stack" className="text-slate-600 text-sm ml-2">
            All Rights Reserved
            <br />
            pushkardutta.com 2024
          </p>
        </div>
      </div>
    </div>
